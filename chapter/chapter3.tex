...
\begin{figure}
	...
	\mycaption{Dimension dependence of waveguide dispersion simulated by Lumerical MODE}{The central wavelength to perform the simulation is 1550 \si{\nm}. We select the fundamental TE mode as the objective to study the waveguide dispersion. The scattered point in the figure is 1.5-\si{\um}-wide and 0.8-\si{\um}-thick.}
	\label{fig:wg-disp}
\end{figure}
...
\begin{figure}
	...
	\mycaption{Parameter sweeping for dispersion flattening using slot structure}{The waveguide thickness is fixed as $t$=0.8.}
...
\begin{figure}
	...
	\end{subfigure}
	\mycaption{Mode field at the taper end by Lumerical FDTD}{The taper edge is profiled in red dashed line.}
	\label{fig:taper}
\end{figure}
