...
Here, the vertical slot waveguide is preferred because it is easy to realized based on the monolithic fabrication process. We propose a double-slot silicon nitride to achieve near-zero and flat dispersion.

In a double vertical slot waveguide illustrated in 


% \begin{figure}
%     \centering
    % \includegraphics{slot}
%     \caption{Caption}
%     \label{fig:my_label}
% \end{figure}
