...
For example, in a 1.5 \si{\um} by 0.8 \si{\um} silicon nitride waveguide cladded by silica, the waveguide dispersion at 1550 nm is 45 \dispu. Substituting into the second-order dispersion chain rule in \autoref{eq:disp-chain}, the second-order mode number dispersion parameter $ D_2 $ is about 12 kHz. This a close to zero dispersion for the pump wavelength.
