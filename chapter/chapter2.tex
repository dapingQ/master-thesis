...
\begin{figure}
	...
	\mycaption{Illustration of wavelength transmission spectrum of ring resonators}{\textbf{a}. Transmission is spectrum determined by coupling condition Only when $ a=\tau $ is critical coupling achieved. \textbf{b}. FSR, free spectral range, the distance between neighboring resonant wavelength. FWHM, full width at half maximum.}
    \label{fig:mrr_spec}
\end{figure}
