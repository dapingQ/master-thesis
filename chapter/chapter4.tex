...
Except the FTIR, it is necessary to evaluated the refractive indexes of the film deposited above. Using the infrared elliposometry,  

\begin{figure}
	\centering
	\includesvg[scale=0.8]{ellipso}
	\mycaption{Elliposometry}{}
	\label{fig:ellipso}
\end{figure}
