...
\section{Top-cladding and annealing}
...
all the samples are first deeply ashed using normal oxygen recipe in another RIE facility. To reduce the damage to the waveguide shape during ashing, organic cleaning is supplied. As same as the buried oxide layer, TEOS source is used to deposit a 2-3 \um top cladding layer with the same LS-CVD facility.
...
\section{Edge coupling and chip dicing}\label{sec:chip-dicing}
