...
\begin{figure}
	...
	\mycaption{Laser microscope images of LIGENTEC devices}{By lowering the focus depth, three layers are observed.
...
\begin{figure}
	...
	\mycaption{Dispersion inversion shown by integrated dispersion}{With film thickness fixed at 0.8 \um, the ring width is tuned from 0.8 \um (Group 1) to 1.7 \um (Group 2) and the mode dispersion is inversed significantly.}
	\label{fig:dint_comp}
\end{figure}
...
We assume that despite the ammonia-free recipe used in NTT-AT technique, the etching recipe is not as fully optimized as LIGENTEC ones. It is also interesting to find that there is a clear difference of FSR trend. In particular, the increasing NTT-AT FSRs indicate a normal dispersion.
