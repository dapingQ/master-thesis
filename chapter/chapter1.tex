...
\begin{figure}
	...
	\mycaption{Illustration of spontaneous four wave mixing in a silicon nitride ring resonator}{By pumping continuous wave laser, nonlinear \ce{Si3N4} ring cavities features comb-like output.}
	\label{fig:fwm_io}
\end{figure}
