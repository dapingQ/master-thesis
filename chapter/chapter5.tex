...
\begin{figure}
	...
	\mycaption{Refractive index and evaluated material dispersion of the film deposited measured via ellipsometry}{The dispersion parameter is calculated by second-order different of fitting curve.}
	\label{fig:ellipso}
\end{figure}
...
\begin{figure}
	...
	\mycaption{Images of fiber launching setup}{\textbf{a} A lensed fiber is aligned with end of bus waveguide. \textbf{b} Chip carried over a thermoelectric cooler. \textbf{c} Photo of waveguide end taken using infrared camera. \textbf{d} Optical microscope of fabricated sample.}
	\label{fig:align}
\end{figure}
...
\begin{figure}
	...
	\mycaption{Integrated dispersion of samples fabricated using different CVD methods}{Evaluated second-order dispersion of LP-CVD and LS-CVD samples presents near perfect dispersion compensation.}
