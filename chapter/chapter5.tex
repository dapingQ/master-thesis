...
For the samples fabricated using subtractive processes, due to the fabrication imperfection, not all the devices show efficient resonance, especially using LP-CVD and PE-CVD deposited samples. The dispersion in the sample fabricated above is only analyzed in the non-absorption range, shown in \autoref{fig:dint_cvd_cf}.
